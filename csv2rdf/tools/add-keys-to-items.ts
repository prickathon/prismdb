...
// item_id,rarity,name,category,image_num,color,brand_name,brand,type,like,outfit_id,series_name,collection_term
// J1-01,HR,しらゆきひめワンピ,ワンピース,71007,青,スイートハニー,sweet_honey,ラブリー,2000,J1-02,みらいコレクション,4月4日（木）～5月22日（水）
